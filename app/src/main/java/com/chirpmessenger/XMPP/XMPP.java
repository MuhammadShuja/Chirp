package com.chirpmessenger.XMPP;
...
public class XMPP{
    ...
    private static String host = "192.168.100.44";
    private static String domain = "geek";
                    ...
                    connection.addConnectionListener(new ConnectionListener() {
                        ...
                        public void reconnectionSuccessful() {
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(mContext, "reconnection successful", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                        ...
                        public void reconnectingIn(final int seconds) {
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(mContext, "reconnecting in: "+seconds, Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                        ...
                        public void reconnectionFailed(final Exception e) {
                            Log.d(TAG, "----------------- reconnection failed: "+e.getMessage());
                            new Handler(Looper.getMainLooper()).post(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(mContext, "reconnection failed: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
